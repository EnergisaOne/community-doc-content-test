...
Thank you for your interest in `community-doc-content-test`, an open source project
administered by StrongLoop.

Contributing to `community-doc-content-test` is easy. In a few simple steps:
